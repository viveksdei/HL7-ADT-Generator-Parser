...
namespace BaseApp.Service.HL7.ADT.AdmitVisit
{
    public class AdmitVisitService : IAdmitVisitService
    {
        ...
        public string FromJsonToHL7AdmitVisit(AdmitVisit_A01_Model admitVisit)
        {
            ...
            AppendPV1Segment(sb, admitVisit.PV1_Patient_Visit);
            return sb.ToString();
        }

        public static string AppendMSHSegment(StringBuilder sb, MSHSegment_A01 msh)
        {
        ...
        public string AppendEVNSegment(StringBuilder sb, EVNSegment_A01 evn)
        {
        ...
        public string AppendPIDSegment(StringBuilder sb, PIDSegment_A01 pid)
        {
        ...
        public static string AppendPV1Segment(StringBuilder sb, PV1Segment_A01 pv1)
        {
      ...
      .Append(pv1.PV1_54_ServiceEpisodeIdentifier ?? "");
        ...
        private void AppendOptionalRepeatableField(StringBuilder sb, List<string>? fieldValues)
        {
            ...
            {
                sb.Append(string.Join(REPEAT_DELIMITER, fieldValues));
            }
        ...
        #region HL7ToJson
        public AdmitVisit_A01_Model FromHL7ToJsonAdmitVisit(string hl7Message)
        {
            var messageModel = new AdmitVisit_A01_Model();
        ...
        private MSHSegment_A01 ParseMSHSegment(string[] fields)
        {
            var mshSegment = new MSHSegment_A01
            {
        ...
        private EVNSegment_A01 ParseEVNSegment(string[] fields)
        {
            var evnSegment = new EVNSegment_A01
            {
        ...
        private PIDSegment_A01 ParsePIDSegment(string[] fields)
        {
            var pidSegment = new PIDSegment_A01
            {
        ...
        private PV1Segment_A01 ParsePV1Segment(string[] fields)
        {
            var pv1Segment = new PV1Segment_A01
            {
