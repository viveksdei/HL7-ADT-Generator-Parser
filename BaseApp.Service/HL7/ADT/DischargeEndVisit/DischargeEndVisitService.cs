...
namespace BaseApp.Service.HL7.ADT.DischargeEndVisit
{
    public class DischargeEndVisitService : IDischargeEndVisitService
    {
        ...
        public string FromJsonToHL7DischargeEndVisit(DischargeEndVisit_A03_Model dischargeEndVisit)
        {
            var sb = new StringBuilder();

            AppendMSHSegment(sb, dischargeEndVisit.MSH_Message_Header);
            AppendEVNSegment(sb, dischargeEndVisit.EVN_Event_Type);
            AppendPIDSegment(sb, dischargeEndVisit.PID_Patient_Identification);
            AppendPV1Segment(sb, dischargeEndVisit.PV1_Patient_Visit);
            return sb.ToString();
        }
        public static string AppendMSHSegment(StringBuilder sb, MSHSegment_A03 msh)
        {
        ...
        public string AppendEVNSegment(StringBuilder sb, EVNSegment_A03 evn)
        {
        ...
        public string AppendPIDSegment(StringBuilder sb, PIDSegment_A03 pid)
        {
        ...
        public static string AppendPV1Segment(StringBuilder sb, PV1Segment_A03 pv1)
        {
      ...
      .Append(pv1.PV1_54_ServiceEpisodeIdentifier ?? "");
        ...
        #region HL7ToJson
        public DischargeEndVisit_A03_Model FromHL7ToJsonDischargeEndVisit(string hl7Message)
        {
            var messageModel = new DischargeEndVisit_A03_Model();
        ...
        private MSHSegment_A03 ParseMSHSegment(string[] fields)
        {
            var mshSegment = new MSHSegment_A03
            {
        ...
        private EVNSegment_A03 ParseEVNSegment(string[] fields)
        {
            var evnSegment = new EVNSegment_A03
            {
        ...
        private PIDSegment_A03 ParsePIDSegment(string[] fields)
        {
            var pidSegment = new PIDSegment_A03
            {
        ...
        private PV1Segment_A03 ParsePV1Segment(string[] fields)
        {
            var pv1Segment = new PV1Segment_A03
            {
